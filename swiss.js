...
function then() {
	...
	for (var division in teams["division"]) {
		console.log('D - ',division)
		for (var sub_division in  teams["division"][division]) {
			console.log('SD - ',sub_division)
			teams["division"][division][sub_division].forEach(function(team) {
				console.log("T:: [",division,"][",sub_division,"]",team.short_name);
